...
class CRNN:
    ...
    def build(input_shape, n_classes, train=True):
        ...
        x = Conv2D(64, kernel_size=(3, 3), activation='relu', padding='same')(input_data)
        x = BatchNormalization(axis=chanDim)(x)
        x = Conv2D(64, kernel_size=(3, 3), activation='relu', padding='same')(x)
        x = BatchNormalization(axis=chanDim)(x)
        shortcut = Conv2D(64, kernel_size=(1, 1), activation='relu', padding='same')(input_data)
        x1 = add([shortcut, x])
        x = Conv2D(64, kernel_size=(3, 3), activation='relu', padding='same')(x1)
        x = BatchNormalization(axis=chanDim)(x)
        x = Conv2D(64, kernel_size=(3, 3), activation='relu', padding='same')(x)
        x = BatchNormalization(axis=chanDim)(x)
        shortcut = Conv2D(64, kernel_size=(1, 1), activation='relu', padding='same')(x1)
        x1 = add([x, shortcut])
        x = Conv2D(64, kernel_size=(3, 3), activation='relu', padding='same')(x1)
        x = BatchNormalization(axis=chanDim)(x)
        x1 = MaxPooling2D(pool_size=(2, 2), strides=(2, 2), name='pool1')(x)

        x = Conv2D(128, kernel_size=(3, 3), activation='relu', padding='same')(x1)
        x = BatchNormalization(axis=chanDim)(x)
        x = Conv2D(128, kernel_size=(3, 3), activation='relu', padding='same')(x)
        x = BatchNormalization(axis=chanDim)(x)
        shortcut = Conv2D(128, kernel_size=(1, 1), activation='relu', padding='same')(x1)
        x1 = add([x, shortcut])
        x = Conv2D(128, kernel_size=(3, 3), activation='relu', padding='same')(x1)
        x = BatchNormalization(axis=chanDim)(x)
        x = Conv2D(128, kernel_size=(3, 3), activation='relu', padding='same')(x)
        ...
        x = Conv2D(256, kernel_size=(3, 3), activation='relu', padding='same')(x1)
        x = BatchNormalization(axis=chanDim)(x)
        x = Conv2D(256, kernel_size=(3, 3), activation='relu', padding='same')(x)
        x = BatchNormalization(axis=chanDim)(x)
        shortcut = Conv2D(256, kernel_size=(1, 1), activation='relu', padding='same')(x1)
        x1 = add([x, shortcut])
        x = Conv2D(256, kernel_size=(3, 3), activation='relu', padding='same')(x1)
        x = BatchNormalization(axis=chanDim)(x)
        x = Conv2D(256, kernel_size=(3, 3), activation='relu', padding='same')(x)
        ...
        x = Conv2D(512, kernel_size=(3, 3), activation='relu', padding='same')(x1)
        x = BatchNormalization(axis=chanDim)(x)
        x = Conv2D(512, kernel_size=(3, 3), activation='relu', padding='same')(x)
        x = BatchNormalization(axis=chanDim)(x)
        shortcut = Conv2D(512, kernel_size=(1, 1), activation='relu', padding='same')(x1)
        x1 = add([x, shortcut])
        x = Conv2D(512, kernel_size=(3, 3), activation='relu', padding='same')(x1)
        x = BatchNormalization(axis=chanDim)(x)
        x = Conv2D(512, kernel_size=(3, 3), activation='relu', padding='same')(x)
        ...
        x = Conv2D(512, kernel_size=(2, 2), strides=(1, 1), activation='relu', padding='valid')(x)
        ...
        rnn_b = CuDNNGRU(256, return_sequences=True, go_backwards=True, name='rnn1_b')(x)
